...
class LinePagerIndicatorDecoration (var colorActive: Int, var colorInactive: Int): RecyclerView.ItemDecoration() {


    val DP = Resources.getSystem().getDisplayMetrics().density;


    var mIndicatorHeight = (DP * 16);


    val mIndicatorItemLength = DP * 16;
    /**
     * Padding between indicators.
     */
    val mIndicatorItemPadding = DP * 4;
